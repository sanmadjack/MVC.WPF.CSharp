...
using Translator;
namespace MVC.WPF {
    public abstract class AViewWindow : System.Windows.Window, ICommunicationReceiver, ITranslateableWindow {
        ...
        public AViewWindow() {
            ...
            ThreadBridge = new ThreadBridge(SynchronizationContext.Current);
